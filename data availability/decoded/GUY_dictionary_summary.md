# Dictionary Summary: GUY — GLFS 2021

**Source files:** GLFS_Bulletin_2021_Third-Quarter.pdf  
**Variables decoded:** 0  
...
- PDF type: TABLE_DICT (DDI format) — table extraction used
-   46 pages total
-   → 0 variables extracted
