# Dictionary Summary: BRA — PNADC 2025

**Source files:** dicionario_PNADC_microdados_2025_visita1_20260417.xls  
**Variables decoded:** 448  
**Variables with value codes:** 0  
**Tables/modules:** 1 (dicionário pnad contínua )  
...
| Demographics | `edad_ci` | ✗ NOT_FOUND |
| Demographics | `sexo_ci` | ✗ NOT_FOUND |
| Demographics | `relacion_ci` | ✗ NOT_FOUND |
...
| Employment status | `condocup_ci` | ✗ NOT_FOUND |
| Employment status | `emp_ci` | ✗ NOT_FOUND |
| Employment status | `desemp_ci` | ✗ NOT_FOUND |
| Employment status | `pea_ci` | ✗ NOT_FOUND |
| Job characteristics | `formal_ci` | ✗ NOT_FOUND |
...
**Coverage: 0/31 HDMF variables likely found (0%)**

---

## Decode Notes

- Source: dicionario_PNADC_microdados_2025_visita1_20260417.xls (1 sheet(s))
- Sheet 'dicionário pnad contínua ': BRA_PNADC layout, 1215 rows
-   → 448 variables extracted
