...
| **Reference period** | 2023 Q3 — July, August, September 2023 |
| **HDMF file code** | `COL_2023t3` |
...
| **Raw file name(s)** | `COL_2023t3.dta` (pre-merged) |
| **Number of modules** | 1 (already merged) |
...
**Known problems**
- Income variables are not yet coded in this wave (commented-out block in `COL_2023t3_variablesBID.do`). Only `remesas_ci` and `remesas_ch` are active.
- Dictionary check required before running: variable names and category codes for 2023 GEIH have not been verified against the 2025 reference. See `COL_dictionary_check_2023_2024.md`.

**Comparability with prior waves**
- 2023 is the earliest GEIH wave in the HDMF system. Use 2025t3 as the reference for all coding decisions.
...
| Field | Value |
|-------|-------|
| **Survey questionnaire** | Refer to DANE GEIH 2023 documentation |
