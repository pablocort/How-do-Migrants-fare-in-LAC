...
Encuesta: SLC
Round: a
Creado por: Eric Torres (erict@iadb.org)
Fecha: Octubre  2022
...
gen dis_ch=. 
	...
	*tamemp_ci
	*************
	*Pequeña 1 a 5 Mediana 6 a 20 Grande Más de 20 (en este caso pequenia es de 1-4 mediana de 5-49 y grande 50-mas)
	gen tamemp_ci=.
...
************************************************************************************************************/
	...
	****************
	/*
      Never worked |      1,180       45.07       45.07
 1 to 3 months ago |        126        4.81       49.89
 4 to 6 months ago |         55        2.10       51.99
7 to 12 months ago |         65        2.48       54.47
Over 12 months ago |      1,192       45.53      100.00
*/
...
Less than 1 year |        404       12.69       12.69
    1 to 4 years |        819       25.72       38.41
    5 to 9 years |        573       18.00       56.41
10 years or over |      1,388       43.59      100.00
	*/
	gen antiguedad_ci=.
...
/*	*************
	...
	*************
	...
	cap gen aedu_ci = .
	replace aedu_ci =0 if q03_01 == 2 /* nunca asistió a la escuela */
		
	* PARA LOS QUE ASISTEN (q03_02==1)
	
	replace aedu_ci = 0                       if asis_niv_inst == 1 & q03_02 == 1 /* prescolar*/
	replace aedu_ci = asis_ano_inst-1         if asis_niv_inst == 2 & q03_02 == 1  	
	replace aedu_ci = asis_ano_inst-1+6       if asis_niv_inst == 3 & q03_02 == 1 /* primaria hasta 6 anios */	
	replace aedu_ci = asis_ano_inst-1+6+4     if asis_niv_inst == 4 & q03_02 == 1 /* secundaria baja 4 anios */
	replace aedu_ci = asis_ano_inst-1+6+4+3   if asis_niv_inst == 5 & q03_02 == 1 /* secundaria alta 3 anios */
	replace aedu_ci = asis_ano_inst-1+6+4+3+4 if asis_niv_inst == 6 & q03_02 == 1 /* grado 4 anios; maestria 2 anios */
	
	* PARA LOS QUE NO ASISTEN PERO ALGUNA VEZ ASISTIERON
	
	replace aedu_ci = 0                       if noasis_niv_inst == 1 & q03_02 == 2    & q03_01 == 1 /* prescolar-ninguno */
	replace aedu_ci = noasis_ano_inst         if noasis_niv_inst == 2 & finalizo ==2  & q03_02 == 2 & q03_01 == 1 /* primaria si no finalizó pongo el grado que finalizó */
	replace aedu_ci = 6				          if noasis_niv_inst == 2 & finalizo ==1  & q03_02 == 2 & q03_01 == 1 /* primaria si finalizó asumo 6 anios */
	replace aedu_ci = noasis_ano_inst+6       if noasis_niv_inst == 3 & finalizo ==2  & q03_02 == 2 & q03_01 == 1 
	replace aedu_ci = 6+4                     if noasis_niv_inst == 3 & finalizo ==1  & q03_02 == 2 & q03_01 == 1 /* secundaria baja 4 anios */
	replace aedu_ci = noasis_ano_inst+6+4     if noasis_niv_inst == 4 & finalizo ==2  & q03_02 == 2 & q03_01 == 1 
	replace aedu_ci = 6+4+3                   if noasis_niv_inst == 4 & finalizo ==1  & q03_02 == 2 & q03_01 == 1 /* secundaria alta 3 anios */
	replace aedu_ci = noasis_ano_inst+6+4+3   if noasis_niv_inst == 5 & finalizo ==2  & q03_02 == 2 & q03_01 == 1 
	replace aedu_ci = 6+4+3+4                 if noasis_niv_inst == 5 & finalizo ==1  & q03_02 == 2 & q03_01 == 1 /* grado 4 anios */
	replace aedu_ci = noasis_ano_inst+6+4+3+4 if noasis_niv_inst == 6 & finalizo ==2  & q03_02 == 2 & q03_01 == 1
	replace aedu_ci = 6+4+3+4+2				  if noasis_niv_inst == 6 & finalizo ==1  & q03_02 == 2 & q03_01 == 1 /* maestria 2 anios */
...
**********************	
    ...
    replace razonesnoasis_ci = 1 if q03_24==2 | q03_24==3
    replace razonesnoasis_ci = 2 if q03_24==1
    replace razonesnoasis_ci = 3 if q03_24==4
    replace razonesnoasis_ci = 5 if q03_24==5
...
* Line of code with indicator repiteult was deleted
	...
	***************
	...
	gen edupub_ci=(q03_03==1) if q03_03!=.
...
*label var aguatrat_ch "= 9 la encuesta no pregunta de si se trata el agua antes de consumirla"
	...
	************
	gen cel_ch=.
	replace cel_ch=1 if q13_23k>=1 
	replace cel_ch=. if q13_23k==. 
...
* Variables incluidas por SCL/MIG Fernando Morales
	...
	**********************
	...
	gen migantiguo5_ci=(migrante_ci==1 & q02_07>4) if migrante_ci!=. & !inrange(edad_ci,0,4)
	replace migantiguo5_ci=. if (q02_07==. & q02_03==1)
	...
	**********************
	...
	gen migrantelac_ci=(migrante_ci==1 & (inlist(q02_01,3,4) | inlist(q02_02,"Argentinie","Haiti","Haitie","Colombia","JAMAICA","Jamaica") | inlist(q02_02,"dominicaanse republi","Trinidad","VENEZUELA","haiti","venezuela"))) if migrante_ci!=. 
	replace migrantelac_ci=. if (q02_01==7 & mi(q02_02))
