...
local varlist "jefe_ci civil_ci edad_ci sexo_ci factor_ci relacion_ci mes_c anio_c pais_c zona_c ine01 region_BID_c region_c nconyuges_ch nmenor1_ch"
...
local varlist "jefe_ci civil_ci edad_ci sexo_ci relacion_ci mes_c anio_c pais_c zona_c ine01 region_BID_c region_c nmenor1_ch"
foreach var of local varlist {
	tab `var',m
}
