...
Autores: Daniela Zuluaga - Email: danielazu@iadb.org
...
*Creación de la variable asistencia a preescolar por Iván Bornacelly - 01/12/17
	g asispre_ci=(e3==1 & e6a==4) // Asiste Kinder Prekinder
...
****************
generate aguared_ch =.
replace aguared_ch = 1 if v20<=3 
replace aguared_ch = 0 if v20>3
...
*****************
gen aguafuente_ch=.
replace aguafuente_ch = 1 if v20<=3 & v22<=2
replace aguafuente_ch = 2 if v20<=3 & v22>2
replace aguafuente_ch = 6 if v20==6
replace aguafuente_ch = 8 if v20==5
replace aguafuente_ch = 10 if (v20==7 | v20==8 | v20==4)
...
replace des1_ch=1 if v23==1 | v23==2
replace des1_ch=2 if v23==3 | v23==4
replace des1_ch=3 if v23==5 | v23==6
...
replace des2_ch=1 if v23>=1 & v23<=4
replace des2_ch=2 if v23==5 | v23==6 | v23==7
...
* telef_ch    *
***************
bysort idh_ch: egen telef_ch=sum(r16b==1)
...
* compu_ch    * 
***************
bysort idh_ch: egen compu_ch=sum(r16d==1)
...
* internet_ch * 
***************
bysort idh_ch: egen internet_ch=sum(r17a==1 | r17b==1 | r17c==1 | r17d==1)
...
* cel_ch    * 
*************
bysort idh_ch: egen cel_ch=sum(r22>=1 & r22<=3)
...
*lp_ci***
*********
*DZG/18: Debería encontrarse en el siguiente link, pero no funciona
*http://observatorio.ministeriodesarrollosocial.gob.cl/ipc_pob_informe3.php?ano=2017
gen lp_ci =  .
