...
quietly infix                  ///
  ...
  byte    educ        109-110  ///
  int     educd       111-113  ///
  byte    gradeatt    114-114  ///
  byte    gradeattd   115-116  ///
  byte    schltype    117-117  ///
  byte    degfield    118-119  ///
  int     degfieldd   120-123  ///
  byte    degfield2   124-125  ///
  int     degfield2d  126-129  ///
  byte    empstat     130-130  ///
  byte    empstatd    131-132  ///
  byte    labforce    133-133  ///
  byte    classwkr    134-134  ///
  byte    classwkrd   135-136  ///
  int     occ         137-140  ///
  int     occ2010     141-144  ///
  int     ind         145-148  ///
  str     indnaics    149-156  ///
  byte    looking     157-157  ///
  byte    availble    158-158  ///
  byte    qcitizen    159-159  ///
  using `"usa_00004.dat"'
...
label define sample_lbl 202402 `"2024 PRCS"'
