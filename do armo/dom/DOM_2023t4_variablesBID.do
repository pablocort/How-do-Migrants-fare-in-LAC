...
Referencia SCL: DOM_2023t4_variablesBID.do (alternative_do_files)
Creado con: Claude HDMF system — 2026-04-21

DIFERENCIAS RESPECTO A 2024:
  - idh_ch: concat(vivienda hogar) — igual que 2024 (concat empieza en 2023)
  - idp_ci: concat(vivienda hogar miembro) — igual que 2024
  - aedu_ci: base secundaria = +6 (igual que 2022-2024)
  - destring: incluidos (confirmado en SCL 2023)
  - tipocontrato_ci: condición extra contrato_verbal_escrito==2 (presente en SCL 2023)
  - FX: 1 USD = 52.78 DOP (stale; SCL 2023 mantiene tasa de 2019)
  - lp_ci/lpe_ci: valor nacional único (sin split zona) — confirmado en SCL 2023:
      lp_ci = 7645.3, lpe_ci = 3643.5
  - salmm_ci = 18702 (confirmado en SCL 2023)
...
log using "`log_dir'/DOM_2023t4_variablesBID.log", replace
...
if c(username)=="PABLOCOR" {
	use "C:\Users\PABLOCOR\OneDrive - Inter-American Development Bank Group\Archivos de Paraiso Pinto Furtado Luzes, Marta - Equipo Conocimiento\Datos\hdmf\How-do-Migrants-fare-in-LAC\bases armo\raw\dom\DOM_2023t4.dta", clear
	local base_out "C:\Users\PABLOCOR\OneDrive - Inter-American Development Bank Group\Archivos de Paraiso Pinto Furtado Luzes, Marta - Equipo Conocimiento\Datos\hdmf\How-do-Migrants-fare-in-LAC\bases armo\armo\DOM\DOM_2023t4_BID.dta"
...
/* 2023: concat() — primer año con nuevo método de IDs (igual que 2024) */
sort vivienda hogar
...
/* 2023: destring confirmado en SCL */
...
/* 2023: condición contrato_verbal_escrito==2 confirmada en SCL 2023 */
gen tipocontrato_ci = .
...
* Tasa de cambio Q4 2023: SCL mantiene 1 USD = 52.78 DOP (stale — tasa real 2023 ≈ 57 DOP)
...
Sistema educativo de República Dominicana (ENCFT):
  nivel_ultimo_ano_aprobado:
    ...
    3  = Secundario        → aedu=último+6
    4  = Secundario-técnico → aedu=último+6
...
/* 2023: línea de pobreza nacional única (sin split zona) — fuente ONE 2023 */
gen lp_ci = 7645.3
label var lp_ci "Linea de pobreza oficial del pais (DOP mensuales, 2023)"

gen lpe_ci = 3643.5
label var lpe_ci "Linea de pobreza extrema del pais (DOP mensuales, 2023)"

/* 2023: salmm_ci = 18702 (confirmado en SCL 2023, fuente TSS) */
gen salmm_ci = 18702
label var salmm_ci "Salario minimo legal mensual (DOP, 2023)"
