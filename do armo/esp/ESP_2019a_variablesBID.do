...
/*------------------------------------------------------------
  ESP_2019a_variablesBID.do
  Spain (ESP) — Encuesta de Población Activa (EPA), 2019 annual
  Input:  bases armo/raw/esp/ESP_2019a_merged.dta
  Output: bases armo/armo/ESP/ESP_2019a_BID.dta
