...
/*------------------------------------------------------------
  ESP_2022a_variablesBID.do
  Spain (ESP) — Encuesta de Población Activa (EPA), 2022 annual
  Input:  bases armo/raw/esp/ESP_2022a_merged.dta
  Output: bases armo/armo/ESP/ESP_2022a_BID.dta
