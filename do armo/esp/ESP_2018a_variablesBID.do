...
/*------------------------------------------------------------
  ESP_2018a_variablesBID.do
  Spain (ESP) — Encuesta de Población Activa (EPA), 2018 annual
  Input:  bases armo/raw/esp/ESP_2018a_merged.dta
  Output: bases armo/armo/ESP/ESP_2018a_BID.dta
...
*   horash = usual/habitual hours → correct ~17% part-time, matches official ESP rate
***********
