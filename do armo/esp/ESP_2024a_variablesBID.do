...
/*------------------------------------------------------------
  ESP_2024a_variablesBID.do
  Spain (ESP) — Encuesta de Población Activa (EPA), 2024 annual
  Input:  bases armo/raw/esp/ESP_2024a_merged.dta
  Output: bases armo/armo/ESP/ESP_2024a_BID.dta
