...
/*------------------------------------------------------------
  ESP_2021a_variablesBID.do
  Spain (ESP) — Encuesta de Población Activa (EPA), 2021 annual
  Input:  bases armo/raw/esp/ESP_2021a_merged.dta
  Output: bases armo/armo/ESP/ESP_2021a_BID.dta
