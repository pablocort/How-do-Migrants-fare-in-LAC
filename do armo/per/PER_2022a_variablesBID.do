...
/***************************************************************************
             ...
             País: Perú | Encuesta: ENAHO | Año: 2022 | Ronda: Annual
...
*************************************************************************** */
	...
	***horastot_ci***
	***************
	/* ALTERNATIVE [dictionary_check_PER 2022a]:
	   p518==99 is a non-response code present in 2019-2022 waves.
	   Clean before rsum to avoid adding 99 hours erroneously.
	   Source: PER_2022a_variablesBID.do (MECOVI reference). */
	...
	***************
	/* ALTERNATIVE [dictionary_check_PER 2022a]:
	   ...
	   Source: PER_2022a_variablesBID.do (MECOVI reference, same logic). */
