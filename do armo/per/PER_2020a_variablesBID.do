...
/***************************************************************************
             ...
             País: Perú | Encuesta: ENAHO | Año: 2020 | Ronda: Annual
             Cloned from PER_2024_variablesBID.do — differences from reference:
               ...
               [3] horastot_ci: p518==99 cleaned before rsum (present in 2019-2022)
             NOTE on condocup_ci: MECOVI 2020 reference uses ocu500 (pre-derived var).
               We use the p501/p502/p503 approach for consistency with other HDMF waves.
...
*************************************************************************** */
	...
	/* ALTERNATIVE [dictionary_check_PER 2020a]: p518==99 present in 2019-2022 */
	...
	*****************
	...
	/* ALTERNATIVE [dictionary_check_PER 2020a]: p558b2 not available before 2024 */
