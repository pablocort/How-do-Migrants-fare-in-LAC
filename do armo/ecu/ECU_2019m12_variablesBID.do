...
* ECU ENEMDU 2019m12 — HDMF harmonization script
* Reference: ECU_2025m12_variablesBID.do
* Changes vs. reference:
*   1. local ANO = "2019" / gen anio_c = 2019
*   2. region_c: ciudad is a numeric integer in 2019 — no destring needed
*   3. ID structure: legacy vars vivienda/hogar/p01 used
*      (id_vivienda/id_hogar/id_persona not present in 2019)
...
use "C:\Users\steffannyr\OneDrive - Inter-American Development Bank Group\Paraiso Pinto Furtado Luzes, Marta's files - Equipo Conocimiento\Datos\hdmf\How-do-Migrants-fare-in-LAC\bases armo\raw\ecu\ECU_2019m12.dta", clear
local base_out = "C:\Users\steffannyr\OneDrive - Inter-American Development Bank Group\Paraiso Pinto Furtado Luzes, Marta's files - Equipo Conocimiento\Datos\hdmf\How-do-Migrants-fare-in-LAC\bases armo\armo\\`PAIS'\\`PAIS'_`ANO'`ronda'_BID.dta"
capture mkdir "C:\Users\steffannyr\OneDrive - Inter-American Development Bank Group\Paraiso Pinto Furtado Luzes, Marta's files - Equipo Conocimiento\Datos\hdmf\How-do-Migrants-fare-in-LAC\bases armo\armo\\`PAIS'"
}

if c(username)=="PABLOCOR" {
use "C:\Users\PABLOCOR\OneDrive - Inter-American Development Bank Group\Archivos de Paraiso Pinto Furtado Luzes, Marta - Equipo Conocimiento\Datos\hdmf\How-do-Migrants-fare-in-LAC\bases armo\raw\ecu\ECU_2019m12.dta", clear
...
***region_c ***
***************
/* ALTERNATIVE: ciudad is a numeric integer in ECU 2019m12 — no destring required.
...
****idh_ch***
*************
/* ALTERNATIVE: Legacy ID structure — id_vivienda/id_hogar not present in ECU 2019.
...
*** edu_hdmf ***
**************
/* DERIVED: edu_hdmf added — not present in original 2019 alternative script.
