...
local base_out = "C:\Users\steffannyr\OneDrive - Inter-American Development Bank Group\Paraiso Pinto Furtado Luzes, Marta's files - Equipo Conocimiento\Datos\hdmf\bases armo\armo\ecu\`PAIS'_`ANO'`ronda'_BID.dta"
...
*use `base_in', clear
*destring *, replace
use "C:\Users\steffannyr\OneDrive - Inter-American Development Bank Group\Paraiso Pinto Furtado Luzes, Marta's files - Equipo Conocimiento\Datos\hdmf\bases armo\raw\ecu\ECU_2025m12.dta", clear
...
***afroind_ano_c***
*******************
**# Por qué es 2010 el año en esta variable?? #1
