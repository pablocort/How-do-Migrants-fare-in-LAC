...
* ECU ENEMDU 2021m12 — HDMF harmonization script
* Reference: ECU_2025m12_variablesBID.do
* Changes vs. reference:
*   1. local ANO = "2021" / gen anio_c = 2021
*   2. region_c: ciudad is a numeric integer in 2021 — no destring needed
*   3. ID structure: legacy vars vivienda/hogar/p01 used
*      (id_vivienda/id_hogar/id_persona not present in 2021)
...
*   6. cotizando_ci: unified formula (p44f==1 | p61b1<=4)
*   7. No income module
*________________________________________________________________________________________________________________*
...
use "C:\Users\steffannyr\OneDrive - Inter-American Development Bank Group\Paraiso Pinto Furtado Luzes, Marta's files - Equipo Conocimiento\Datos\hdmf\How-do-Migrants-fare-in-LAC\bases armo\raw\ecu\ECU_2021m12.dta", clear
local base_out = "C:\Users\steffannyr\OneDrive - Inter-American Development Bank Group\Paraiso Pinto Furtado Luzes, Marta's files - Equipo Conocimiento\Datos\hdmf\How-do-Migrants-fare-in-LAC\bases armo\armo\\`PAIS'\\`PAIS'_`ANO'`ronda'_BID.dta"
capture mkdir "C:\Users\steffannyr\OneDrive - Inter-American Development Bank Group\Paraiso Pinto Furtado Luzes, Marta's files - Equipo Conocimiento\Datos\hdmf\How-do-Migrants-fare-in-LAC\bases armo\armo\\`PAIS'"
}

if c(username)=="PABLOCOR" {
use "C:\Users\PABLOCOR\OneDrive - Inter-American Development Bank Group\Archivos de Paraiso Pinto Furtado Luzes, Marta - Equipo Conocimiento\Datos\hdmf\How-do-Migrants-fare-in-LAC\bases armo\raw\ecu\ECU_2021m12.dta", clear
...
***region_c ***
***************
/* ALTERNATIVE: ciudad is a numeric integer in ECU 2021m12 — no destring required.
   Direct integer division used instead of destring+_ciudad as in 2024/2025. */
gen region_c = .
...
****idh_ch***
*************
/* ALTERNATIVE: Legacy ID structure — id_vivienda/id_hogar not present in ECU 2021.
...
*** edu_hdmf ***
**************
/* DERIVED: edu_hdmf added — not present in original 2021 alternative script.
