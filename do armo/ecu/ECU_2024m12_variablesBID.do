...
* ECU ENEMDU 2024m12 — HDMF harmonization script
* Reference: ECU_2025m12_variablesBID.do
* Changes vs. reference:
*   1. local ANO = "2024" / gen anio_c = 2024
*   2. miembros_ci: added (required by HDMF codebook; missing from 2025 reference)
*   3. No income module
* All other variable construction identical to 2025 reference (new ID structure, destring ciudad).
*________________________________________________________________________________________________________________*
...
use "C:\Users\steffannyr\OneDrive - Inter-American Development Bank Group\Paraiso Pinto Furtado Luzes, Marta's files - Equipo Conocimiento\Datos\hdmf\How-do-Migrants-fare-in-LAC\bases armo\raw\ecu\ECU_2024m12.dta", clear
local base_out = "C:\Users\steffannyr\OneDrive - Inter-American Development Bank Group\Paraiso Pinto Furtado Luzes, Marta's files - Equipo Conocimiento\Datos\hdmf\How-do-Migrants-fare-in-LAC\bases armo\armo\\`PAIS'\\`PAIS'_`ANO'`ronda'_BID.dta"
capture mkdir "C:\Users\steffannyr\OneDrive - Inter-American Development Bank Group\Paraiso Pinto Furtado Luzes, Marta's files - Equipo Conocimiento\Datos\hdmf\How-do-Migrants-fare-in-LAC\bases armo\armo\\`PAIS'"
}

if c(username)=="PABLOCOR" {
use "C:\Users\PABLOCOR\OneDrive - Inter-American Development Bank Group\Archivos de Paraiso Pinto Furtado Luzes, Marta - Equipo Conocimiento\Datos\hdmf\How-do-Migrants-fare-in-LAC\bases armo\raw\ecu\ECU_2024m12.dta", clear
...
/* DERIVED: Added to all HDMF waves — required by codebook. Not in 2025 reference script.
   Threshold <=5 consistent with 2018-2023 waves for cross-wave comparability. */
