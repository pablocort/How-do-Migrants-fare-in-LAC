...
use "\\sapidbshares.file.core.windows.net\idbshares\SURVEYS\survey\CHL\CASEN\2024\data_orig\casen_2024.dta"
...
*tipopen_ci*****
****************
gen vejez=1 if y29_1b==1
gen invalidez=1 if (y29_1c==1) | (y29_1d==1) | (y29_1e==1)
gen montepio=1 if y29_1f==1 
...
***tamemp_ci**
**************
gen tamemp_ci=1 if o25==1 | o25==2 
replace tamemp_ci=2 if o25==3 | o25==4
replace tamemp_ci=3 if o25==5 | o25==6
label var tamemp_ci "# empleados en la empresa segun rangos"
label define tamemp_ci 1 "Pequena" 2 "Mediana" 3 "Grande"
label value tamemp_ci tamemp_ci
gen tamemp_o=1 if o25==1 | o25==2 | o25==3
replace tamemp_o=2 if o25==4 
replace tamemp_o=3 if o25==5 | o25==6
...
/*_____________________________________________________________________________________________________*/
  ...
  horaspri_ci horastot_ci tiempoparc_ci categopri_ci categosec_ci rama_ci spublico_ci tamemp_ci tamemp_o cotizando_ci instcot_ci	afiliado_ci /// Empleo 
  ...
  salmm_ci /*lp19_2011 lp31_201 lp5_2011 lp_ci lpe_ci lp365_2017 lp685_2017 lp14_2017 lp81_2017 tc_c cpi_c cpi2011 cpi2017 ratio_cpi2011 ratio_cpi2017 1 /// Fuente externa
